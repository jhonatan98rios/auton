...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: InfraredService */

  /***/
  function srcApp_servicesInfraredServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "InfraredService", function () {
    ...
    var InfraredService = /*#__PURE__*/function () {
      function InfraredService(http) {
        _classCallCheck(this, InfraredService);

        this.http = http;
        this.user = JSON.parse(localStorage.getItem('currentUser'));
      }

      _createClass(InfraredService, [{
        key: "runCommand",
        value: function runCommand(device, command) {
          var requestParams = {
            id: device.id,
            command: command,
            protocol: device.protocol
          };
          return this.http.post("".concat(this.user.ddns, "/command/"), requestParams).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) {
            return response;
          }));
        }
      }, {
        key: "changeBright",
        value: function changeBright(device, command, bright) {
          var requestParams = {
            id: device.id,
            command: command,
            protocol: device.protocol,
    ...
    InfraredService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    InfraredService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], InfraredService);
    /***/
  }
