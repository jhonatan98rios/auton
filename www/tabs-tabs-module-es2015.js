...
const routes = [
    {
        ...
        children: [
            {
                path: 'comodos',
                loadChildren: () => Promise.all(/*! import() | comodos-comodos-module */[__webpack_require__.e("default~cenas-cenas-module~comodos-comodos-module~controles-ar-condicionado-ar-condicionado-module~c~7aa20ed3"), __webpack_require__.e("comodos-comodos-module")]).then(__webpack_require__.bind(null, /*! ../comodos/comodos.module */ "./src/app/comodos/comodos.module.ts")).then(m => m.ComodosPageModule),
                canActivate: [_helpers_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
            },
            {
                path: 'cenas',
                loadChildren: () => Promise.all(/*! import() | cenas-cenas-module */[__webpack_require__.e("default~cenas-cenas-module~comodos-comodos-module~controles-ar-condicionado-ar-condicionado-module~c~7aa20ed3"), __webpack_require__.e("cenas-cenas-module")]).then(__webpack_require__.bind(null, /*! ../cenas/cenas.module */ "./src/app/cenas/cenas.module.ts")).then(m => m.CenasPageModule),
                canActivate: [_helpers_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
            },
            {
                path: 'perfil',
                loadChildren: () => Promise.all(/*! import() | perfil-perfil-module */[__webpack_require__.e("default~cenas-cenas-module~comodos-comodos-module~controles-ar-condicionado-ar-condicionado-module~c~7aa20ed3"), __webpack_require__.e("perfil-perfil-module")]).then(__webpack_require__.bind(null, /*! ../perfil/perfil.module */ "./src/app/perfil/perfil.module.ts")).then(m => m.PerfilPageModule),
                canActivate: [_helpers_auth_guard__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]]
            },
            {
                path: '',
