...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InfraredService", function() { return InfraredService; });
...
let InfraredService = class InfraredService {
    constructor(http) {
        this.http = http;
    ...
    runCommand(device, command) {
        ...
        return this.http.post(`${this.user.ddns}/command/`, requestParams)
...
InfraredService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
InfraredService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
